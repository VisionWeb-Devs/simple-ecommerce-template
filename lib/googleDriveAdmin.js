...
function formatFormData(formData) {
  const formattedData = {
    ...
    productCategory: formData.get("product_category").toLocaleLowerCase(),
...
const getImages = async (productId) => {
  ...
  const main_image = res.data.files.filter((image) =>
  ...
  return {
    main_image: {
      ...
      mimeType: main_image.mimeType,
      webContentLink: main_image.webContentLink,
    },
